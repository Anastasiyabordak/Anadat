...
| :------: | :------: | :------: | :------: | :------: | :------: |
| 1 |  Изменение значений каждого цвета (rgb) | Открыть приложение "Anadat". Нажать на "Transform image". Система открывает окно редактирования изображения. Откройте изображение sd-3layers.jpg. Установите для поля "Red" знак ">=" со значением 150, для поля "Green" знак ">=" со значением 40, для поля "Blue" знак "<=" 75 | | | PASS |
| 2 | Закрашивание ненужной области  определённым цветом| Открыть приложение "Anadat". Нажать на "Transform image". Система открывает окно редактирования изображения. Откройте изображение sd-3layers.jpg | |  | PASS |
| 3 | Отмена/повтор действия| Открыть приложение "Anadat". Нажать на "Transform image". Система открывает окно редактирования изображения. Откройте изображение sd-3layers.jpg | |  |  PASS |
